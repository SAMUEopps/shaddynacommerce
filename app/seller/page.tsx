...
import { FaChartPie, FaUser, FaBox, FaShoppingCart, FaMoneyBill, FaComments, FaTruck, FaBullhorn, FaChartLine, FaBalanceScale, FaStore, FaGlobe } from "react-icons/fa";
...
const SellerPage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <h1 className="text-3xl font-bold text-center mb-8">Shop Management</h1>
